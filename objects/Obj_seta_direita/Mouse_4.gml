...
//        var new_x = x + grid_size;  // Calcula nova posição
//        var new_y = y;
...
//        } else {
 ...
 //   }
//}
        // Botão direita (Left Pressed) - ATUALIZADO
// Só adiciona se não estiver executando e limite de 5 movimentos
if (!Obj_player.executing && array_length(Obj_player.move_sequence) < Obj_player.max_moves) {
    array_push(Obj_player.move_sequence, 0);  // 0 = direita
